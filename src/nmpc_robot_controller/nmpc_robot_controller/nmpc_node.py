...
class NMPCController(Node):
    ...
    def __init__(self):
        ...
        self.model = load_model("/home/bertrandt/b.ob/src/nmpc_robot_controller/nmpc_robot_controller/functions/path_following_obs_avoidance_model.h5")
        # self.model = load_model("/home/ubuntu/b.ob/src/nmpc_robot_controller/nmpc_robot_controller/functions/path_following_obs_avoidance_model.h5")
    ...
    def control_loop(self):
        ...
        if self.global_path!=None and self.dt > 0 and goal_dist>0.2:
            ...
            x_hat, y_hat, theta_hat, s_hat, eta,obs_x_hat,_obs_y_hat,relevant_flag = T_z_obs(self.global_path, self.current_state[0], self.current_state[1], self.current_state[2], self.s0, self.obs_position[0], self.obs_position[1],self.obs_r)
