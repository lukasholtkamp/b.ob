...
const double targetX = 6.10; 
const double targetY = 5.05;

const double lowerV = -0.25; // lower and upper constraints for control input linear
const double upperV = 0.5;
const double lowerW = -60.0 * M_PI / 180.0; // lower and upper constraints for control inputs angular
const double upperW = 60.0 * M_PI / 180.0;
const double targetV = 0.2;

const double goalWeight = 1.0;
const double obsWeight = 0.0;
const double speedWeight = 1.0;

const double lookaheadDist_ = 0.5;
const double safetyRadius = 0.05; // Safety radius to avoid obstacles (robot radiua in this case - burger)
